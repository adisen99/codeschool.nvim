...
-- styles check
if not utils.tobool(vim.g.codeschool_bold) then
  styles.bold = "NONE"
end

if not utils.tobool(vim.g.codeschool_underline) then
  styles.underline = "NONE"
end

if not utils.tobool(vim.g.codeschool_italic) then
  styles.italic = "NONE"
end
...
if utils.tobool(vim.g.codeschool_invert_signs) then
...
if not utils.tobool(vim.g.codeschool_italicize_comments) then
...
if utils.tobool(vim.g.codeschool_italicize_strings) then
